...
<EnderIO:blockPoweredSpawner>			.addTooltip(format.red(format.bold("This item is DISABLED!")));
...
AlloySmelter.addRecipe(fusedQuartz, <gregtech:gt.metaitem.01:2522> * 8, dustGlass, 100, 16);
