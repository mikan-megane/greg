...
Mixer.addRecipe(dirt, null, [<minecraft:sand>, <IC2:itemFertilizer> * 5], <liquid:water> * 1000, 35, 8);
Mixer.addRecipe(dirt, null, [<minecraft:sand>, <Forestry:mulch> * 3], <liquid:water> * 1000, 31, 8);
