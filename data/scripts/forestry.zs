...
recipes.addShaped(centrifuge, [
    [plateNaquadah, <gregtech:gt.metaitem.01:32686>, plateNaquadah],
    [darkIronBars, <gregtech:gt.blockmachines:367>, darkIronBars],
    [<gregtech:gt.metaitem.02:31373>, <gregtech:gt.metaitem.01:32686>, <gregtech:gt.metaitem.02:31373>]]);
...
Carpenter.removeRecipe(<Forestry:craftingMaterial:4>);
Carpenter.addRecipe(<Forestry:craftingMaterial:4>, [[<Forestry:royalJelly>, <MagicBees:drop:1>, <Forestry:royalJelly>],
                                [<Forestry:royalJelly>, <GalacticraftCore:item.fuelCanisterPartial:1>, <Forestry:royalJelly>],
                                [<minecraft:gunpowder>, <MagicBees:drop:1>, <minecraft:gunpowder>]], liquidWater * 2000, 500);
